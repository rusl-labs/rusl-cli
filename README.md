...
Use the canonical forms above. Shorter schema and bundle identifiers are accepted for
compatibility and normalized when written.

#### Version requirements

Each resource value is a version requirement string:
...
| --- | --- | --- |
| `[rusl.resources]` | yes (for dependencies) | Schema and bundle dependencies. Keys are resource identifiers; values are version requirements. |
...
Legacy tables `[schemas]` and `[bundles]` are still read for compatibility. Prefer
`[rusl.resources]` in new manifests.
