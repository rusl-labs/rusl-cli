# RuslWebApiBundleControllerPaginateRequest
...
**filters** | Option<[**Vec<models::RuslWebApiBundleControllerIndexFiltersParameterValue>**](RuslWebApiBundleControllerIndexFiltersParameterValue.md)> | List of filters representing filter operations on specific fields. Filters are applied in the order they are defined. | [optional]
...
**order_by** | Option<**Vec<OrderBy>**> | Fields to order by. Optional because these endpoints define a default order; include to override it. (enum: inserted_at, slug, favourite_count, watcher_count, endorsement_count, attached_annotation_count, bundle_inclusion_count) | [optional]
