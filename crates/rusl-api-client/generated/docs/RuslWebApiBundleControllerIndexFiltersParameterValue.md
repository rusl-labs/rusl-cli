# RuslWebApiBundleControllerIndexFiltersParameterValue

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**field** | **Field** | Field to filter on (enum: q, identifier, account_slug, slug, bundle_identifier, visibility, status) |
