...
**filters** | Option<[**Vec<models::RuslWebApiSchemaControllerPaginateRequestFiltersInner>**](RuslWebApiSchemaControllerPaginateRequestFiltersInner.md)> | List of filters represents a filter operation on a specific field. The filters are applied in the order they are defined. | [optional]
**first** | Option<**i32**> | First | [optional][default to 20]
**last** | Option<**i32**> | Last | [optional][default to 20]
**order_by** | **Vec<OrderBy>** | List of fields to order by (enum: created_order, slug) | 
