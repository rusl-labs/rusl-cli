...
**content** | Option<**std::collections::HashMap<String, serde_json::Value>**> | Discovery payload conforming to the rusl/discovery-profile JSON Schema. Null for pending or failed profiles. Canonical schema: http://localhost:4000/schemas/rusl/discovery-profile | [optional]
