...
**annotation_type_id** | Option<**String**> | Registered annotation type ID when the type comes from the registry | [optional]
...
**r#type** | **String** | Annotation type (e.g. ui-schema, storage-policy) | 
