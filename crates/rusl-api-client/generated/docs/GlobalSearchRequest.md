...
**identifiers** | Option<**Vec<String>**> | Restrict results to exact canonical resource identifiers. | [optional]
...
**types** | Option<**Vec<Types>**> | Restrict global search to specific result types. (enum: schema, annotation_type, annotation, bundle) | [optional]
