...
> models::RuslWebApiUserControllerShow200Response rusl_web_api_user_controller_show(id)
Get user by ID
...
[**models::RuslWebApiUserControllerShow200Response**](RuslWeb_Api_UserController_show_200_response.md)
...
> models::RegisterUserResponse1 rusl_web_api_user_registration_controller_register(open_api_schema1)
Register a new user
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**open_api_schema1** | Option<[**OpenApiSchema1**](OpenApiSchema1.md)> | Register New User Request |  |
