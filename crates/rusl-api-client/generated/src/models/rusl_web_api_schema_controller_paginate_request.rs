...
impl RuslWebApiSchemaControllerPaginateRequest {
    ...
    pub fn new() -> RuslWebApiSchemaControllerPaginateRequest {
        RuslWebApiSchemaControllerPaginateRequest {
            after: None,
            before: None,
            filters: None,
...
pub enum OrderBy {
    ...
    #[serde(rename = "validation_schema_usage_count")]
    ValidationSchemaUsageCount,
    #[serde(rename = "dependent_schema_count")]
