...
/// ReviewThread : A review thread on a proposal with one root comment and flat replies
...
impl ReviewThread {
    ...
    pub fn new(__typename: Typename, created_by_user_id: String, id: String, inserted_at: String, status: Status, subject_guid: String, updated_at: String) -> ReviewThread {
        ReviewThread {
            __typename,
            bookmark: None,
            comments: None,
