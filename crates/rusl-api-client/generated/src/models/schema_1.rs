...
impl Schema1 {
    /// Schema
    pub fn new(__typename: Typename, account_slug: String, id: String, inserted_at: String, schema_format: SchemaFormat, schema_identifier: String, slug: String, status: Status, updated_at: String) -> Schema1 {
        Schema1 {
            __typename,
            account_slug,
            archived_at: None,
