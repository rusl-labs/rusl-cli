...
/// ResourceOrigin1 : Durable provenance edge for a schema or bundle
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ResourceOrigin1 {
...
impl ResourceOrigin1 {
    /// Durable provenance edge for a schema or bundle
    pub fn new(__typename: Typename, id: String, inserted_at: String, relationship_type: RelationshipType, source_kind: SourceKind, subject_guid: String, subject_type: SubjectType, updated_at: String) -> ResourceOrigin1 {
        ResourceOrigin1 {
            __typename,
