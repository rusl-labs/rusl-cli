...
pub struct RuslWebApiBundleControllerPaginateRequest {
    ...
    pub filters: Option<Option<Vec<models::RuslWebApiBundleControllerPaginateRequestFiltersInner>>>,
    /// First
    #[serde(
        rename = "first",
        default,
...
impl RuslWebApiBundleControllerPaginateRequest {
    pub fn new(order_by: Vec<OrderBy>) -> RuslWebApiBundleControllerPaginateRequest {
