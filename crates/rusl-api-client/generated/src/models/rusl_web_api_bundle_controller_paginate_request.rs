...
pub struct RuslWebApiBundleControllerPaginateRequest {
    ...
    pub filters: Option<Option<Vec<models::RuslWebApiBundleControllerIndexFiltersParameterValue>>>,
