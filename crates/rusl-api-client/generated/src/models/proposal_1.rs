...
impl Proposal1 {
    /// Schema Proposal
    pub fn new(__typename: Typename, content: serde_json::Value, guid: String, id: String, inserted_at: String, root_instance_types: Vec<String>, schema_id: String, status: Status, updated_at: String, valid_data: Vec<models::ExampleData1>) -> Proposal1 {
        Proposal1 {
            __typename,
            accepted_at: None,
