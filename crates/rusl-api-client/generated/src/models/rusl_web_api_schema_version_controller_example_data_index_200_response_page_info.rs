...
/// RuslWebApiSchemaVersionControllerExampleDataIndex200ResponsePageInfo : Pagination metadata. Some fields are only populated for specific pagination modes and are otherwise null.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct RuslWebApiSchemaVersionControllerExampleDataIndex200ResponsePageInfo {
    /// Current offset for offset or page pagination
    #[serde(rename = "current_offset", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "end_cursor", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "next_offset", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "previous_offset", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub previous_offset: Option<Option<i32>>,
    /// Previous page number for page or offset pagination
    #[serde(rename = "previous_page", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub previous_page: Option<Option<i32>>,
    /// Cursor for the first item in the current cursor window
    #[serde(rename = "start_cursor", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "total_pages", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub total_pages: Option<Option<i32>>,
}

impl RuslWebApiSchemaVersionControllerExampleDataIndex200ResponsePageInfo {
    /// Pagination metadata. Some fields are only populated for specific pagination modes and are otherwise null.
    pub fn new(has_next_page: bool, has_previous_page: bool) -> RuslWebApiSchemaVersionControllerExampleDataIndex200ResponsePageInfo {
