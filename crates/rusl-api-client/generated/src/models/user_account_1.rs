...
/// UserAccount1 : User Account
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UserAccount1 {
    /// Type discriminator
...
impl UserAccount1 {
    /// User Account
    pub fn new(__typename: Typename, guid: String, inserted_at: String, owner_user_id: String, plan: String, slug: String, r#type: Type, updated_at: String) -> UserAccount1 {
        UserAccount1 {
            __typename,
