...
/// CreateResourceOriginRequest1 : Create non-fork provenance for a schema or bundle
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CreateResourceOriginRequest1 {
    #[serde(
